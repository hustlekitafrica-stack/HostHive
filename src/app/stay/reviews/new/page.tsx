...
function WriteReviewContent() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setSuccess(true);
      setTimeout(() => {
        router.push(propertyId ? `/stay/rooms/${toRoomSlug(null, propertyName, propertyId)}` : '/stay/rooms');
      }, 2200);
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-white pt-16 pb-16">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
        ...
        {/* Back */}
        <Link
          href={propertyId ? `/stay/rooms/${toRoomSlug(null, propertyName, propertyId)}` : '/stay/rooms'}
