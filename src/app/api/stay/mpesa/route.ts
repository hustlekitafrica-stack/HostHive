...
// ─── TODO: Fill in these env vars in your .env.local ────────────────────────
// MPESA_CONSUMER_KEY=
// MPESA_CONSUMER_SECRET=
// MPESA_SHORTCODE=           (your Lipa Na M-Pesa shortcode / Till / Paybill)
// MPESA_PASSKEY=             (Lipa Na M-Pesa Online passkey from Daraja portal)
// MPESA_CALLBACK_URL=        (public HTTPS URL e.g. https://yourapp.com/api/stay/mpesa/callback)
...
// POST /api/stay/mpesa
// Body: { phone: string; amount: number; account_ref: string; description: string }
export async function POST(req: NextRequest) {
  try {
    ...
    const payload = {
      ...
      AccountReference:  account_ref  ?? 'Kogelo Order',
      TransactionDesc:   description  ?? 'Food Order',
    };
