    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-5 py-8">
          ...
          <form onSubmit={handleContinue} className="space-y-4">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                className="w-full px-4 py-3 bg-white border border-gray-300 rounded-md text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:border-transparent transition-all text-sm"
        ...
        <div className="flex gap-3 justify-center">
          ...
          <button
            type="button"
            className="flex-1 flex items-center justify-center py-3 border border-gray-300 rounded-md hover:bg-gray-50 transition-colors"
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 text-center">
          <p className="text-xs text-gray-400 leading-relaxed">
            ...
            <button className="underline transition-colors" style={{ color: '#16a34a' }}>Terms &amp; conditions</button>
            {' '}and{' '}
