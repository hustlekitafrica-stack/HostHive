...
export default function AlertsPage() {
  ...
  useEffect(() => {
    setUserEmail(localStorage.getItem('user_email') || 'demo@hostbooks.ke');
  }, []);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`p-6 transition-all duration-300 ${sidebarCollapsed ? 'lg:pl-[280px] lg:pr-[200px]' : 'lg:pl-[456px] lg:pr-[200px]'}`}>
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <button onClick={loadData} className="text-xs text-gray-500 hover:text-gray-800 flex items-center gap-1 border border-gray-200 rounded-lg px-3 py-1.5 transition-colors">
