  ...
  return (
    <div className="flex h-screen bg-gray-50 flex-col lg:flex-row">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className={`flex-1 overflow-y-auto overflow-x-hidden lg:pt-0 ${['/booking-calendar','/alerts','/guests','/unit-performance','/properties','/expenses','/reports','/settings','/help'].includes(pathname) ? 'pt-0' : 'pt-32'}`}>
          <BrandProvider>
            {children}
          </BrandProvider>
        </main>
