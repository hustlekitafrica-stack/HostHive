      ...
      >
        ...
        <SidebarSection title="ACCOUNTS" collapsed={collapsed}>
          ...
          <button
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-lg w-full transition-all duration-200 text-slate-400 hover:text-slate-300 hover:bg-slate-700/50 ${
          ...
          >
            ...
            {!collapsed && <span className="flex-1 text-sm font-medium whitespace-nowrap">Log out</span>}
            {collapsed && (
              <div className="absolute left-full ml-2 px-2 py-1 bg-slate-900 text-white text-xs rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50">Log out</div>
            )}
          </button>
        </SidebarSection>
      </div>
