  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* POS Section */}
        <SidebarSection title="POS" collapsed={collapsed}>
          <a href="/pos" target="_blank" rel="noopener noreferrer">
            <div
              className="flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 ease-in-out relative group text-slate-400 hover:text-slate-300 hover:bg-slate-700/50"
            >
              ...
              {!collapsed && <span className="flex-1 text-sm font-medium whitespace-nowrap">Open POS Terminal</span>}
              {collapsed && (
          ...
          <SidebarItem
            ...
            label="Inventory"
            href="/pos-inventory"
            isActive={isActive('/pos-inventory')}
            collapsed={collapsed}
          />
          <SidebarItem
            icon={
          ...
          <SidebarItem
            ...
            href="https://pos.kogelosuites.com"
            isActive={false}
            collapsed={collapsed}
          />
        </SidebarSection>
